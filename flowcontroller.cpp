...
{
    uiGestionEtudiant = new GestionEtudiant(this);
    uiGestionEtudiant->show();
...
/*
    ...
    de la page de gestion des formateurs(GestionFormateur)
*/
void FlowController::onUIGestionEtudiantCreerClicked()
{

}

void FlowController::onUIGestionEtudiantModifierClicked()
{

}

void FlowController::onUIGestionEtudiantSupprimerClicked()
{

}

void FlowController::onUIGestionEtudiantListerClicked()
{

}

void FlowController::onUIGestionEtudiantRechercherClicked()
{

}

void FlowController::onUIGestionEtudiantValiderClicked()
{
