...
private:
    ...
    GestionEtudiant* uiGestionEtudiant;
...
private slots:
    ...
    */
    ...
    /*
        les fonctions à executer suite au click des boutons respectifs
        de la page de gestion des Etudiants(GestionEtudiant)
    */
    void onUIGestionEtudiantValiderClicked();
    void onUIGestionEtudiantCreerClicked();
    void onUIGestionEtudiantModifierClicked();
    void onUIGestionEtudiantSupprimerClicked();
    void onUIGestionEtudiantListerClicked();
    void onUIGestionEtudiantRechercherClicked();
